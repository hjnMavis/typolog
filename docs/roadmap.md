...
| 2-2 | DB 스키마 생성 | Drizzle 스키마 정의, 마이그레이션 실행 |
...
| 2-7 | 챌린지 API | 오늘의 문장 조회, seed 데이터 |
...
| 3-5 | 내 콜라주 목록 | /my 페이지, 날짜순 정렬 |
| 3-6 | 공개/비공개 전환 | 제출 후에도 토글 가능 |
| 3-7 | 공유 페이지 | /share/[id], 비인증 접근, OG 메타태그 |
