...
인증: 불필요
응답: {
  id, sentence, letters, active_date
}
로직:
...
```sql
INSERT INTO challenges (sentence, letters, active_date) VALUES
  ('오늘도 화이팅', '{오,늘,도,화,이,팅}', '2026-05-26'),
  ('좋은 하루', '{좋,은,하,루}', '2026-05-27'),
  ('비 온 뒤 맑음', '{비,온,뒤,맑,음}', '2026-05-28'),
  ('커피 한 잔', '{커,피,한,잔}', '2026-05-29'),
  ('오늘의 발견', '{오,늘,의,발,견}', '2026-05-30'),
  ('걸어서 출근', '{걸,어,서,출,근}', '2026-05-31'),
  ('햇살이 좋다', '{햇,살,이,좋,다}', '2026-06-01'),
  ('우리 동네', '{우,리,동,네}', '2026-06-02'),
  ('작은 행복', '{작,은,행,복}', '2026-06-03'),
  ('가을 바람', '{가,을,바,람}', '2026-06-04'),
  ('내일도 파이팅', '{내,일,도,파,이,팅}', '2026-06-05'),
  ('잘 먹겠습니다', '{잘,먹,겠,습,니,다}', '2026-06-06'),
  ('서울 산책', '{서,울,산,책}', '2026-06-07'),
  ('감사합니다', '{감,사,합,니,다}', '2026-06-08');
```
